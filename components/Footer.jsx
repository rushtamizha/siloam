...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full border-t border-slate-200 bg-white pt-16 pb-6 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-10 pb-12 md:grid-cols-2 lg:grid-cols-12 border-b border-slate-100">
          ...
          <div className="space-y-5 lg:col-span-4">
            <Link href="/" className="flex items-center gap-2.5 cursor-pointer group">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-emerald-50 text-emerald-800 border border-emerald-100 shadow-sm overflow-hidden">
                <img src="/logo.jpg" className="w-full h-full object-cover rounded-full" alt="logo" />
              </div>
              <div className="flex flex-col justify-center leading-tight">
                <p className="text-base font-black tracking-tight text-slate-900">
          ...
          <div className="space-y-4 lg:col-span-2">
            ...
            <ul className="space-y-2.5 text-xs font-semibold text-slate-500">
              {["Blood Test Services", "Bedside ECG Service", "Digital X-Ray Service", "Portable X-Ray For Horses", "Portable X-Ray For Veterinary"].map((service, i) => (
                <li key={i}>
                  <Link href="/#services" className="transition-colors hover:text-emerald-600 flex items-center gap-1 group">
                    <ArrowRight className="h-3 w-3 opacity-0 -ml-4 transition-all group-hover:opacity-100 group-hover:ml-0 text-emerald-600" />
                    {service}
          ...
          <div className="space-y-4 lg:col-span-3">
            ...
            <ul className="space-y-3 text-xs font-semibold text-slate-500">
              ...
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4 text-emerald-600 shrink-0" />
                <a href="tel:+919629007513" className="transition-colors hover:text-emerald-600">+91 96290 07513</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-emerald-600 shrink-0" />
                <a href="mailto:siloamdiagnostic0@gmail.com" className="transition-colors hover:text-emerald-600">siloamdiagnostic0@gmail.com</a>
          ...
          <div className="space-y-4 lg:col-span-3">
            ...
            <div className="relative h-40 w-full overflow-hidden rounded-[1.5rem] border border-slate-200/80 shadow-sm bg-slate-50">
              <iframe
                title="Siloam Diagnostics Location"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.823620257602!2d79.2655122!3d12.983130499999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bad496fcc633953%3A0x3e0a8699162691e4!2sSiloam%20diagnostic!5e0!3m2!1sen!2sin!4v1782299531860!5m2!1sen!2sin"
                className="absolute inset-0 h-full w-full border-0 transition-all duration-500 grayscale hover:grayscale-0"
                allowFullScreen=""
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
              />
        ...
        {/* PREMIUM HIGH-CTR AGENCY ATTRIBUTION BAR */}
        <div className="mt-6 pt-4 border-t border-slate-100 flex justify-center items-center">
          ...
          >
            <a 
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-slate-100 bg-slate-50/60 shadow-[0_2px_10px_rgba(0,0,0,0.01)] transition-all hover:bg-emerald-50/40 hover:border-emerald-200/50 hover:shadow-sm text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-emerald-900 group"
            >
              {/* Animated Live Pulse Dot Loop */}
              ...
              <span className="text-slate-900 group-hover:text-emerald-600 transition-colors">wepzite.in</span>
